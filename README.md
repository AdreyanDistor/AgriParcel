...
|-----------------|--------|--------------------------------------------|-----------------------------------------------------------------------------------------------|
| `--input`       | str    | `data/test_data`                           | Path to the directory containing input `.tif` satellite imagery for mask generation.          |
...
| `--maskdir`     | str    | `outputs/farmland_masks`                  | Directory where intermediate RGBA `.tif` masks will be saved.                                |
...
| `--conf`        | float  | `0.7`                                      | CLIP classification confidence threshold (only masks with higher confidence are retained).    |
